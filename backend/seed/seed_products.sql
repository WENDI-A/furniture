...
('SKU-TABLE-001', 'Coffee Table', 'Elegant wooden table', 'Elegant wooden table for your living room or office.', 'Table', 'C', 179.99, 'Coffee Table.jpg', TRUE, TRUE),
...
('SKU-CHAIR-002', 'Lounge Chair', 'Comfortable relaxing chair', 'Comfortable chair perfect for relaxing indoors.', 'Chair', 'A', 229.99, 'LoungeChair.jpg', TRUE, FALSE),
...
('SKU-TABLE-004', 'Streamlined Table', 'Chrome-finished legs', 'Streamlined table with chrome-finished legs.', 'Table', 'C', 209.99, 'StreamlinedTable.jpg', TRUE, FALSE),
